...
public class HappyValentinsDay extends JFrame {
    ...
    public static final int screenWidth = (int) Toolkit.getDefaultToolkit().

            getScreenSize().

            getWidth();
    public static final int screenHeight = (int) Toolkit.getDefaultToolkit().
    ...
    public HappyValentinsDay() {
        label = new JLabel("Hi, my name is huzhenyang, I love you, do you love me?", SwingConstants.CENTER); // 自行修改
